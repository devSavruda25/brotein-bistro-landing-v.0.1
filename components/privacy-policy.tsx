    ...
    <div className="relative bg-white overflow-hidden">
      ...
      <section className="relative py-20 lg:py-32 bg-gradient-to-br from-gray-50 to-white overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-32 h-32 bg-blue-300 rounded-full opacity-20 animate-pulse" />
          <div className="absolute bottom-20 right-10 w-24 h-24 bg-green-300 rounded-full opacity-20 animate-pulse" />
          <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-purple-300 rounded-full opacity-20 animate-pulse" />
          <div className="absolute top-2/1 left-1/2 w-16 h-16 bg-purple-300 rounded-full opacity-20 animate-pulse" />
        </div>
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-blue-700 font-medium">Privacy & Data Protection</span>
            </motion.div>
            ...
            >
              {[
                ...
                >
                  <div className={`w-12 h-12 ${stat.color} mx-auto mb-2`}>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {tableOfContents.map((item, index) => (
                    <motion.a
                      ...
                      whileHover={{ x: 5 }}
                    >
                      <div className="w-6 h-6 bg-green-100 text-green-600 rounded-full flex items-center justify-center text-sm font-medium mr-3 group-hover:bg-green-500 group-hover:text-white transition-colors duration-200">
                        {index + 1}
                      </div>
          ...
          <div className="max-w-4xl mx-auto space-y-16">
            ...
            >
              <h2 className="text-3xl font-bold mb-8 flex items-center">
                <Database className="mr-3 h-8 w-8 text-green-500" />
                Information We Collect
              </h2>
                  ...
                  >
                    <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                      <CardContent className="p-6">
                        <div
                          className={`w-12 h-12 bg-gradient-to-r ${type.color} rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                        >
              ...
              <Card className="bg-blue-50 border-blue-200">
                <CardContent className="p-6">
                  <div className="flex items-start">
                    <AlertTriangle className="h-6 w-6 text-blue-500 mr-3 mt-1 flex-shrink-0" />
                    <div>
                      ...
                      <CardContent className="p-6">
                        <div className="flex items-start">
                          <div className="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                            <use.icon className="h-5 w-5 text-green-600" />
                          </div>
                          <div>
            ...
            >
              ...
              <div className="space-y-6">
                <h3 className="text-xl font-bold mb-4">We Never Share Your Data</h3>
                <Card className="bg-green-50 border-green-200 mb-6">
                  <CardContent className="p-6">
                    <div className="flex items-start">
                      <Lock className="h-6 w-6 text-green-500 mr-3 mt-1 flex-shrink-0" />
                      <div>
                        <h4 className="font-bold text-green-800 mb-2">Strict No-Sharing Policy</h4>
                ...
                <h4 className="text-lg font-semibold mb-4">Limited Sharing Only For:</h4>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <ul className="space-y-3">
                      {[
                        ...
                        <motion.li
                          ...
                          transition={{ delay: index * 0.1 }}
                        >
                          <Mail className="h-4 w-4 text-green-500 mr-3 mt-1 flex-shrink-0" />
                ...
                <Card className="bg-blue-50 border-blue-200">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold mb-4 text-blue-800">Easy Opt-Out Options</h3>
                    <ul className="space-y-3">
                      {[
                        ...
                        <motion.li
                          ...
                          transition={{ delay: index * 0.1 }}
                        >
                          <CheckCircle className="h-4 w-4 text-blue-600 mr-3 mt-1 flex-shrink-0" />
                          <span className="text-blue-700 text-sm">{option}</span>
                        </motion.li>
                      ))}
                    </ul>
                  </CardContent>
            ...
            >
              ...
              <Card className="border-0 shadow-xl bg-gradient-to-br from-orange-50 to-red-50">
                <CardContent className="p-8">
                  <h3 className="text-xl font-bold mb-6">Get Franchise Form Data</h3>
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      <h4 className="font-bold mb-4 text-orange-800">Secure Storage</h4>
                      <ul className="space-y-3">
                        {[
                          ...
                          <motion.li
                            ...
                            transition={{ delay: index * 0.1 }}
                          >
                            <Shield className="h-4 w-4 text-orange-600 mr-3 mt-1 flex-shrink-0" />
                    ...
                    <div>
                      <h4 className="font-bold mb-4 text-red-800">Confidentiality Promise</h4>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <ul className="space-y-3">
                      {securityMeasures.map((measure, index) => (
                        <motion.li
                          ...
                          transition={{ delay: index * 0.1 }}
                        >
                          <Shield className="h-4 w-4 text-green-500 mr-3 mt-1 flex-shrink-0" />
                ...
                <Card className="bg-green-50 border-green-200">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold mb-4 text-green-800">Your Role in Security</h3>
                    <ul className="space-y-3">
                      {[
            ...
            >
              <h2 className="text-3xl font-bold mb-8 flex items-center">
                <UserCheck className="mr-3 h-8 w-8 text-green-500" />
                Your Rights
              </h2>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                {userRights.map((right, index) => (
                  ...
                  >
                    <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                      <CardContent className="p-6">
                        <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-blue-500 group-hover:scale-110 transition-all duration-300">
                          <right.icon className="h-6 w-6 text-blue-600 group-hover:text-white" />
                        </div>
              ...
              <Card className="bg-blue-50 border-blue-200">
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold mb-4 text-blue-800">How to Exercise Your Rights</h3>
            ...
            >
              <h2 className="text-3xl font-bold mb-6 flex items-center">
                <Cookie className="mr-3 h-8 w-8 text-green-500" />
                Consent & Updates
              </h2>
              <Card className="border-0 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    {[
                      ...
                      <div key={cookie.type} className="text-center p-4 bg-gray-50 rounded-lg">
                        <h4 className="font-bold mb-2">{cookie.type}</h4>
            ...
            >
              ...
              <Card className="border-0 shadow-xl bg-gradient-to-br from-green-50 to-blue-50">
                <CardContent className="p-8">
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      <h3 className="text-xl font-bold mb-6">Privacy Questions?</h3>
                      <div className="space-y-4">
                        <div className="flex items-center">
                          <Mail className="h-5 w-5 text-green-500 mr-3" />
                          <span>privacy@broteinbistro.com</span>
                        </div>
                        <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-6">Data Protection Officer</h3>
                      <p className="text-gray-700 mb-4">
